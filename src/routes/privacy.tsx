  ...
  head: () => ({
    meta: [
      { title: "Privacy Policy — Makeena Jordan" },
      {
        name: "description",
        content:
          "Read Makeena Jordan's Privacy Policy to learn how we collect, use and protect your personal data.",
      },
      { property: "og:title", content: "Privacy Policy — Makeena Jordan" },
      {
...
function PrivacyPage() {
  return (
    <LegalShell title="Privacy Policy" backTo="/">
      <section>
      ...
      <section>
        ...
        <p className="mt-2 text-muted-foreground">For the purposes of this Privacy Policy:</p>
        <ul className="mt-4 list-disc space-y-2 pl-6 text-muted-foreground">
          ...
          <li>
            ...
            Agreement) refers to Makeena Trading Services, Amer Bin Malek 70.
          </li>
          <li>
      ...
      <section>
        ...
        <h4 className="mt-3 text-base font-semibold">Personal Data</h4>
        <p className="mt-2 text-muted-foreground">
        ...
        <h4 className="mt-4 text-base font-semibold">Usage Data</h4>
        <p className="mt-2 text-muted-foreground">
      ...
      <section>
        ...
        <p className="mt-4 text-muted-foreground">We use both session and persistent Cookies for the purposes set out below:</p>
      ...
      <section>
        ...
        <p className="mt-4 text-muted-foreground">We may share your personal information in the following situations:</p>
        <ul className="mt-4 list-disc space-y-2 pl-6 text-muted-foreground">
          <li>
      ...
      <section>
        ...
        <h3 className="mt-4 text-lg font-semibold">Business Transactions</h3>
        <p className="mt-2 text-muted-foreground">
          If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be
          transferred. We will provide notice before Your Personal Data is transferred and becomes subject
          to a different Privacy Policy.
        </p>
        <h3 className="mt-4 text-lg font-semibold">Law enforcement</h3>
        <p className="mt-2 text-muted-foreground">
        ...
        <h3 className="mt-4 text-lg font-semibold">Other legal requirements</h3>
        <p className="mt-2 text-muted-foreground">
      ...
      <section>
        ...
        <h3 className="mt-4 text-lg font-semibold">California Privacy Rights for Minor Users</h3>
        <p className="mt-2 text-muted-foreground">
