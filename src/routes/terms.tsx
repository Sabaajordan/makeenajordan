  ...
  head: () => ({
    meta: [
      { title: "Terms and Conditions — Makeena Jordan" },
      {
        name: "description",
        content:
          "Read the Terms and Conditions for using Makeena Jordan's vending machine services and website.",
      },
      { property: "og:title", content: "Terms and Conditions — Makeena Jordan" },
      {
...
function TermsPage() {
  return (
    <LegalShell title="Terms and Conditions" backTo="/">
      <section>
      ...
      <section>
        ...
        <ul className="mt-4 list-disc space-y-2 pl-6 text-muted-foreground">
          ...
          <li>
            ...
            Agreement) refers to Makeena for Trading services, 70, Amer Bin Malek Street, Khalda.
          </li>
          <li>
      ...
      <section>
        ...
        <p className="mt-4 text-muted-foreground">
          ...
          kind that the Service will meet Your requirements, achieve any intended results, be compatible or
      ...
      <section>
        <h2 className="text-2xl font-semibold">For European Union (EU) Users</h2>
        <p className="mt-4 text-muted-foreground">
      ...
      <section>
        ...
        <h3 className="mt-4 text-lg font-semibold">Severability</h3>
        <p className="mt-2 text-muted-foreground">
          If any provision of these Terms is held to be unenforceable or invalid, such provision will be
          changed and interpreted to accomplish the objectives of such provision to the greatest extent
          possible under applicable law and the remaining provisions will continue in full force and effect.
        </p>
        <h3 className="mt-4 text-lg font-semibold">Waiver</h3>
        <p className="mt-2 text-muted-foreground">
